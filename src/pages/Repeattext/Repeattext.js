...
const Repeattext = () => {
  ...
  const handleClick = () => {
    if (text === "") {
      const data = "Type or paste your content here".repeat(5);
      clipboard(data);
      alert(`!You have copied "${data}"`);
    } else {
      const data = text.repeat(5);
      clipboard(data);
      alert(`!You have copied "${data}"`);
    }
  };
          ...
          <div className="">
            <div>
              ...
              <p className="text-sm font-normal">
                This is a browser tool that allows you to generate certain text
                over and over again. Simply type in the text you want repeating,
                amend the settings and generate all the text you want.
              </p>
            </div>
