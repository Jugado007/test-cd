    ...
    <>
      <div>
        ...
        <div className="mainbg max-w-[1260px] m-auto px-[15px] py-[10px]">
          <div className="">
            <div>
              <h1 className=" text-[#e27235] text-[16px] sm:text-[22px] md:text-2xl font-bold mb-[10px]">
                Free Online Notepad
              </h1>
            ...
            <textarea
              ...
              className="text-sm p-[10px] w-full min-h-[24vh] bg-[#ffede4] h-[190px] focus:outline-0"
              onChange={(e) => {
              ...
              <div className="">
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className="border  px-[5px] py-[5px] text-sm font-bold text-[#e27235] bg-[#ffede4]  font-trebuchet transition-all  text-start"
                  >
                    Download Text
                  </button>
                  <button
                  ...
                  <button className="border  px-[5px] py-[5px] text-sm font-bold text-[#e27235] bg-[#ffede4]  font-trebuchet  transition-all  text-start">
                    Print
                  </button>
                </div>
              </div>
          ...
          <div className="w-full lg:w-[900px] mt-[15px] m-auto">
            <div className="flex gap-3 flex-wrap items-center justify-center mb-[15px]">
              {Notepad.map((lang, i) => {
                return (
                  <div key={i}>
                    <button className="hover:text-[#335ef7] border  px-[5px] py-[2px] text-sm font-bold text-[#e27235] bg-[#ffede4]  transition-all  text-start">
                      {lang.datalang}
                    </button>
                  </div>
                );
            ...
            <p className="text-sm max-w-[800px] text-center">
              ...
              you can use right here in your web browser. You are able to create
              a whole range of notes, ideas, and to do lists that you’re able to
              simply copy and paste the text where you would like. This is a
              simple to use minimalistic online notepad that also comes with an
              autosave feature - allowing you to essentially store your text
              (you can see more about just how that works in the ‘how does this
              work’ section. It essentially allows you to come back and visit
              your text notes anytime you want provided you use the same browser
              and device and haven’t cleared cookies.
            </p>
          </div>
        </div>
        <Footer />
