...
const Romantext = () => {
  ...
  const handleClick = () => {
    if (text === "") {
      const data = "I/XXIV/MMXXIII";
      clipboard(data);
      alert(`!You have copied "${data}"`);
    } else {
      const data = stringify(text);
      clipboard(data);
      alert(`!You have copied "${data}"`);
    }
  };
  ...
  const onClickDownload = () => {
    if (text === "") {
      const data = zalgo("Type or paste your content here");
          ...
          <div className="">
            <div>
              ...
              <p className="text-sm font-normal">
                It simply takes a normal date such as 27/7/2022 and converts it
                into a Roman Numeral date - XXVII/VII/MMXXII. Try it on the
                panel and see it automatically converted.
              </p>
            </div>
