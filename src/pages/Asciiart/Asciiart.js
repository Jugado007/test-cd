        ...
        <>
            <div>
                ...
                <div className='mainbg max-w-[1260px] m-auto px-[15px] py-[10px]'>
                    <div className=''>
                        <div>
                            <h1 className='text-[16px] sm:text-[22px] md:text-2xl text-[#e27235] font-bold mb-[10px]'>Text to Image Generator</h1>
                    ...
                    <div className='w-full  lg:w-[900px] mt-[15px] m-auto'>
                        <div>
                            {Arttext.map((data, i) => {
                                return (
                                    <div key={i} className='card mx-[6px] p-[15px] mb-[15px] bg-white border rounded-lg'>
